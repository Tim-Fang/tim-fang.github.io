  ...
  return (function (e) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        function (e) {
          ...
          function a(e, t, n) {
            ...
            return (
              t &&
                (t._preactCompatRendered = i && (i._component || { base: i })),
              "function" == typeof n && n(),
              (i && i._component) || i
            );
          }
          function u(e, t, n, r) {
            var o = G.h(J, { context: e.context }, t),
              i = a(o, n);
          ...
          function v(e, t) {
            ...
            return (
              ...
              m(G.cloneElement.apply(void 0, a))
            );
          }
          function g(e) {
          ...
          function b(e) {
            ...
            if (n && "string" == typeof t) {
              ...
              if (
                ...
                n[i] ||
                  ((n[i] = A([n[i], n[r.onchange]])), delete n[r.onchange]);
              }
            }
          }
          function w(e) {
          ...
          function M(e, t) {
            P.call(this, e, t),
              ...
              (this.render = A([P, j, this.render || "render", D]));
          }
          function P(e, t) {
            if (e) {
              var n = e.children;
          ...
          G.options.event = function (e) {
            return (
              $ && (e = $(e)), (e.persist = Object), (e.nativeEvent = e), e
            );
          };
          ...
          return (
            ...
            c.timezone
              ...
              : ((g = new Date(y + b).getTimezoneOffset()),
                (g = new Date(y + b + g * p).getTimezoneOffset())),
            new Date(y + b + g * p)
          );
        }
        return new Date(e);
    ...
    function (e, t, n) {
      ...
      (t.isElementAnSFC = function (e) {
        return !(
          "string" == typeof e.type || e.type.prototype.isReactComponent
        );
      }),
    ...
    function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        return o.default.createElement(
          ...
          o.default.createElement("img", { src: t, alt: "头像" })
        );
      };
    },
    function (e, t, n) {
            ...
            (0, u.default)(e, [
              {
                ...
                value: function (e) {
                  ...
                  else if (!(t = window.document.getElementById(e)))
                    throw new Error(
            ...
            for (var c in e)
              if (e.hasOwnProperty(c)) {
                ...
                if (
                  ...
                  var p = s ? s() : "";
                  o(
                    "Failed " + r + " type: " + l.message + (null != p ? p : "")
                  );
                }
              }
        }
      ...
      !(function () {
        ...
        function n(e, n) {
          ...
          for (
            n &&
            null != n.children &&
            (P.length || P.push(n.children), delete n.children);
            P.length;
        ...
        function i(e) {
          !e.__d &&
            (e.__d = !0) &&
            1 == I.push(e) &&
            (M.debounceRendering || setTimeout)(a);
        }
        function a() {
          var e,
            t = I;
        ...
        function g(e, t, n, r, o) {
          ...
          if (
            ((F =
              "svg" === t.nodeName || ("foreignObject" !== t.nodeName && F)),
            (!e || !s(e, String(t.nodeName))) &&
              ((i = l(String(t.nodeName), F)), e))
          ) {
          ...
          return (
            ...
            null == u.nextSibling
              ...
              : ((f && f.length) || null != u) &&
                y(i, f, n, r, G || null != c.dangerouslySetInnerHTML),
            _(i, t.attributes, c),
            (F = a),
            i
          );
        ...
        function y(e, t, n, r, o) {
          ...
          if (0 !== w)
            for (var _ = 0; _ < w; _++) {
              ...
              var S = s.key;
              if (null != S)
                h && void 0 !== d[S] && ((c = d[S]), (d[S] = void 0), h--);
              else if (!c && m < y)
                for (i = m; i < y; i++)
        ...
        function E(e, t, n) {
          ...
          if (
            (e.prototype && e.prototype.render
              ...
              : ((r = new T(t, n)), (r.constructor = e), (r.render = S)),
            o)
          )
        ...
        function C(e, t, n, r, o) {
          e.__x ||
            ...
            (e.__x = !1),
            0 !== n &&
              (1 !== n && !1 === M.syncComponentUpdates && e.base
                ? i(e)
                : N(e, 1, o)),
            e.__r && e.__r(e));
        }
          ...
          if (!e.__x) {
            ...
            if (
              ...
              if ("function" == typeof T) {
                var A = c(i);
                (a = _),
                  a && a.constructor === T && A.key == a.__k
                    ? C(a, A, 1, f, !1)
                    : ((S = a),
                      (e._component = a = E(T, A, f)),
                      (a.__b = a.__b || y),
                      (a.__u = e),
                      C(a, A, 0, f, !1),
                      N(a, 1, n, !0)),
                ...
                (u = w),
                  (S = _),
                  S && (u = e._component = null),
                  (w || 1 === t) &&
                    (u && (u._component = null),
                    (O = v(u, i, f, n || !g, w && w.parentNode, !0)));
              if (w && O !== w && a !== _) {
                var P = w.parentNode;
                P &&
                  O !== P &&
                  (P.replaceChild(O, w),
                  S || ((w._component = null), b(w, !1)));
              }
        ...
        !(function (t, n) {
          ...
          function P(e, t) {
            (this._instanceConstructor = e),
              ...
              this.promise[ee] || M(this.promise),
              z(t)
          ...
          return (
            ...
            (P.prototype._settledAt = function (e, t, n) {
              var r = this.promise;
              r._state === te &&
                (this._remaining--, e === re ? E(r, n) : (this._result[t] = n)),
        ...
        B = (function (e) {
          function t(e) {
            ...
            (n.state = {
              ...
              (n.handlePopup = function (e) {
                ...
                var t = !n.state.isPopupVisible,
                  r = function e(t) {
                    (0, N.hasClassInParent)(t.target, "gt-user", "gt-popup") ||
            ...
            r &&
              ...
              window.localStorage.removeItem(R.GT_COMMENT));
            ...
            (0, d.default)(t, [
                    ...
                    .post(
                      "/repos/" + n + "/" + r + "/issues",
                      {
                        ...
                        body:
                          ...
                          s +
                            " \n\n " +
                            ((0, N.getMetaContent)("description") ||
                              (0, N.getMetaContent)(
                                "description",
                                "og:description"
                              ) ||
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return b.default.createElement(
                    ...
                    {
                      className:
                        "gt-container" + (i ? " gt-input-focused" : ""),
                    },
                    t && this.initing(),
                    !t && (n ? [] : [this.meta()]),
                    r &&
              ...
              },
              {
                ...
                get: function () {
                  return (
                    this._accessToke ||
                    window.localStorage.getItem(R.GT_ACCESS_TOKEN)
                  );
                },
                set: function (e) {
                  window.localStorage.setItem(R.GT_ACCESS_TOKEN, e),
                    (this._accessToken = e);
                },
              },
              {
    ...
    function (e, t, n) {
      ...
      var r = n(1),
        ...
        K = function (e) {
          ...
          return (
            !(this === B && o(F, e) && !o(G, e)) &&
            (!(t || !o(this, e) || !o(F, e) || (o(this, D) && this[D][e])) || t)
          );
        },
        J = function (e, t) {
          if (((e = w(e)), (t = _(t, !0)), e !== B || !o(F, t) || o(G, t))) {
            var n = k(e, t);
            return (
              !n || !o(F, t) || (o(e, D) && e[D][t]) || (n.enumerable = !0), n
            );
          }
        },
        Z = function (e) {
      ...
      H ||
        ...
        (n(28).f = K),
        (n(44).f = Q),
        i && !n(20) && u(B, "propertyIsEnumerable", K, !0),
        (h.f = function (e) {
          return V(d(e));
        })),
      ...
      a(a.S + a.F * !H, "Symbol", {
        ...
        M.prototype[I] || n(11)(M.prototype, I, M.prototype.valueOf),
        f(M, "Symbol"),
        f(Math, "Math", !0),
        f(r.JSON, "JSON", !0);
    },
        ...
        b = (function (e) {
          function t() {
            ...
            return (
              ...
              (r.state = {
                children: f.Children.toArray(r.props.children).map(function (
                  e
                ) {
                    ...
                    value: function (e) {
                      ...
                      this.checkForStatelessFunctionalComponents(t.children),
                        void 0 !== e.disableAnimations &&
                          ("production" !== v &&
                            (0, d.deprecatedDisableAnimations)(),
...
*/
    ...
    function (e, t) {
      e.exports = {
        ...
        "please-contact":
          "Por favor contacta con %{user} para inicializar el comentario",
    ...
    function (e, t) {
      e.exports = {
        ...
        "please-contact":
          "S’il vous plaît contactez %{user} pour initialiser les commentaires",
    ...
    function (e, t) {
      e.exports = {
        ...
        "please-contact":
          "Пожалуйста, свяжитесь с %{user} чтобы инициализировать комментарий",
                    ...
                    m.default.createElement(
                      ...
                      m.default.createElement(
                        ...
                        p &&
                          m.default.createElement(
                            "a",
                            { className: "gt-comment-like", onClick: c },
                            p.viewerHasReacted
                        ...
                        l
                          ...
                          : m.default.createElement(
                              "a",
                              { className: "gt-comment-reply", onClick: s },
                              m.default.createElement(b.default, {
    ...
    function (e, t, n) {
      function r(e, t, n) {
        ...
        var v,
          g,
          y = { addSuffix: Boolean(r.addSuffix), comparison: d };
    ...
    function (e, t, n) {
      ...
      function r(e) {
        ...
        return a.axiosGithub
          .post(
            "/graphql",
            u({ owner: r, repo: o, id: e.number, pageSize: s, cursor: p }, c),
          ...
          .then(function (n) {
            ...
            s =
              "last" === c
                ? [].concat((0, i.default)(u), (0, i.default)(d))
                : [].concat((0, i.default)(d), (0, i.default)(u));
            var f =
              !1 === a.pageInfo.hasPreviousPage ||
              !1 === a.pageInfo.hasNextPage;
            return (
              t.setState({
                comments: s,
                isLoadOver: f,
        ...
        "Array",
        {
          from: function (e) {
            ...
            if (
              ...
              for (t = s(p.length), n = new d(t); t > g; g++)
                c(n, g, v ? m(p[g], g) : p[g]);
            else
